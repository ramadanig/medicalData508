...
import com.vcu.dbtheory.repository.PrescriptionRepository;
...
public class PrescriptionResourceIntTest {
    ...
    private static final Integer DEFAULT_REFILLS = 0;
    private static final Integer UPDATED_REFILLS = 1;
    ...
    public static Prescription createEntity(EntityManager em) {
        ...
        // Add required entity
        Medication medication = MedicationResourceIntTest.createEntity(em);
    ...
    public void createPrescription() throws Exception {
        ...
        assertThat(testPrescription.getDosage()).isEqualTo(DEFAULT_DOSAGE);
        assertThat(testPrescription.getExpiration()).isEqualTo(DEFAULT_EXPIRATION);
        assertThat(testPrescription.getRefills()).isEqualTo(DEFAULT_REFILLS);
    }
    ...
    @Test
    @Transactional
    public void checkDosageIsRequired() throws Exception {
    ...
    @Test
    @Transactional
    public void checkExpirationIsRequired() throws Exception {
        int databaseSizeBeforeTest = prescriptionRepository.findAll().size();
        // set the field null
        prescription.setExpiration(null);
    ...
    @Test
    @Transactional
    public void checkRefillsIsRequired() throws Exception {
        int databaseSizeBeforeTest = prescriptionRepository.findAll().size();
        // set the field null
        prescription.setRefills(null);
    ...
    public void getAllPrescriptions() throws Exception {
        ...
        restPrescriptionMockMvc.perform(get("/api/prescriptions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].refills").value(hasItem(DEFAULT_REFILLS)));
    }
    ...
    public void getPrescription() throws Exception {
        ...
        restPrescriptionMockMvc.perform(get("/api/prescriptions/{id}", prescription.getId()))
            ...
            .andExpect(jsonPath("$.refills").value(DEFAULT_REFILLS));
    }
    ...
    public void updatePrescription() throws Exception {
        ...
        Prescription testPrescription = prescriptionList.get(prescriptionList.size() - 1);
        assertThat(testPrescription.getDosage()).isEqualTo(UPDATED_DOSAGE);
        assertThat(testPrescription.getExpiration()).isEqualTo(UPDATED_EXPIRATION);
        assertThat(testPrescription.getRefills()).isEqualTo(UPDATED_REFILLS);
    }
