...
export class PrescriptionService {
     ...
     */
    private convertItemFromServer(json: any): Prescription {
        const entity: Prescription = Object.assign(new Prescription(), json);
        entity.expiration = this.dateUtils
            .convertLocalDateFromServer(json.expiration);
        return entity;
    }
    ...
    private convert(prescription: Prescription): Prescription {
        ...
        copy.expiration = this.dateUtils
            .convertLocalDateToServer(prescription.expiration);
        return copy;
    }
}
